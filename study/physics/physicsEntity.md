...
Though the physics entity makes up the smalletst and simplest of the comonents in the engine, it is the most important. As noted previusly, the entity will represent each element on the screen. Entities in both games and physiscs, represent the object's state by holding all the relevant metadata to that entity, as shown below.

#### Entity JavaScript object
